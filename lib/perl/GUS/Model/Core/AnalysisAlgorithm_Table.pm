package GUS::Model::Core::AnalysisAlgorithm_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ...
      ['GUS::Model::Core::TableInfo','table_id','table_id'],
  ...
  $self->setAttInfo(
      {'col' => 'analysis_algorithm_id', 'type' => 'NUMBER', 'prec' => 10, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'table_id', 'type' => 'NUMBER', 'prec' => 5, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'row_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::Core::AnalysisAlgorithm');
  ...
  $self->setPrimaryKeyList('analysis_algorithm_id');
