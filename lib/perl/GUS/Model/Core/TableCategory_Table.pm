package GUS::Model::Core::TableCategory_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ['GUS::Model::Core::Category','category_id','category_id'],
  ...
  $self->setAttInfo(
      {'col' => 'table_category_id', 'type' => 'NUMBER', 'prec' => 5, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'category_id', 'type' => 'NUMBER', 'prec' => 5, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::Core::TableCategory');
  ...
  $self->setPrimaryKeyList('table_category_id');
