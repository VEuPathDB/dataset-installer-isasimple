package GUS::Model::Core::DatabaseVersion_Row;
...
sub setDatabaseVersionId {
  my($self,$value) = @_;
  $self->set("database_version_id",$value);
}

sub getDatabaseVersionId {
    my($self) = @_;
  return $self->get("database_version_id");
}
