package GUS::Model::Core::UserGroup_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ['GUS::Model::Core::GroupInfo','group_id','group_id'],
  ...
  $self->setAttInfo(
      {'col' => 'user_group_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::Core::UserGroup');
  ...
  $self->addToParentList(['GUS::Model::Core::GroupInfo','group_id','group_id']);
  $self->setHasSequence(0);

  $self->setPrimaryKeyList('user_group_id');
