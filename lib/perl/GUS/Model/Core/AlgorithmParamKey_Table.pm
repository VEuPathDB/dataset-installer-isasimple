package GUS::Model::Core::AlgorithmParamKey_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::Core::AlgorithmParam','algorithm_param_key_id','algorithm_param_key_id']);

  $self->setParentList(
      ['GUS::Model::Core::AlgorithmImplementation','algorithm_implementation_id','algorithm_implementation_id'],
      ['GUS::Model::Core::AlgorithmParamKeyType','algorithm_param_key_type_id','algorithm_param_key_type_id'],
  ...
  $self->setAttInfo(
      ...
      {'col' => 'algorithm_param_key', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 60, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'algorithm_param_key_type_id', 'type' => 'NUMBER', 'prec' => 3, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'is_list_valued', 'type' => 'NUMBER', 'prec' => 1, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'description', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 1024, 'Nulls' => 1, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::Core::AlgorithmParamKey');
  ...
  $self->setPrimaryKeyList('algorithm_param_key_id');
