package GUS::Model::Core::DatabaseDocumentation_Table;
...
sub setDefaultParams {
  ...
  $self->setAttInfo(
      {'col' => 'database_documentation_id', 'type' => 'NUMBER', 'prec' => 10, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'table_id', 'type' => 'NUMBER', 'prec' => 5, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'attribute_name', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 120, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'html_documentation', 'type' => 'CLOB', 'prec' => '', 'length' => 4000, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::Core::DatabaseDocumentation');
  ...
  $self->setPrimaryKeyList('database_documentation_id');
