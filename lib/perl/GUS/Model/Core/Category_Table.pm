package GUS::Model::Core::Category_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::Core::TableCategory','category_id','category_id']);
  ...
  $self->setRealTableName('GUS::Model::Core::Category');
  ...
  $self->setPrimaryKeyList('category_id');
