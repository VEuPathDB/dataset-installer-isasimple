package GUS::Model::Core::DatabaseInfo_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::Core::TableInfo','database_id','database_id']);
  ...
  $self->setAttInfo(
      ...
      {'col' => 'name', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 60, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'description', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 500, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::Core::DatabaseInfo');
  ...
  $self->setPrimaryKeyList('database_id');
