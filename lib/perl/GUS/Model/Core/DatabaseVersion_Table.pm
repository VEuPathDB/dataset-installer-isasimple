package GUS::Model::Core::DatabaseVersion_Table;
...
sub setDefaultParams {
  ...
  $self->setAttInfo(
      {'col' => 'database_version_id', 'type' => 'NUMBER', 'prec' => 5, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'version', 'type' => 'FLOAT', 'prec' => 126, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::Core::DatabaseVersion');
  ...
  $self->setPrimaryKeyList('database_version_id');
