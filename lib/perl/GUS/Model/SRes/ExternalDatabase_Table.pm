package GUS::Model::SRes::ExternalDatabase_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::DoTS::RejectedMotif','external_database_id','external_database_id'],
      ['GUS::Model::SRes::ExternalDatabaseRelease','external_database_id','external_database_id']);
  ...
  $self->setAttInfo(
      ...
      {'col' => 'name', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 150, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::SRes::ExternalDatabase');
  ...
  $self->setPrimaryKeyList('external_database_id');
