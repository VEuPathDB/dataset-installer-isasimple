package GUS::Model::SRes::OntologyTermType_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::SRes::OntologyTerm','ontology_term_type_id','ontology_term_type_id']);
  ...
  $self->setAttInfo(
      {'col' => 'ontology_term_type_id', 'type' => 'NUMBER', 'prec' => 5, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'name', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 50, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'description', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 100, 'Nulls' => 1, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::SRes::OntologyTermType');
  ...
  $self->setPrimaryKeyList('ontology_term_type_id');
