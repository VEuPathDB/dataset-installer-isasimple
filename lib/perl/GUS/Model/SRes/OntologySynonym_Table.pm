package GUS::Model::SRes::OntologySynonym_Table;
...
sub setDefaultParams {
  ...
  $self->setAttInfo(
      {'col' => 'ontology_synonym_id', 'type' => 'NUMBER', 'prec' => 10, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'ontology_term_id', 'type' => 'NUMBER', 'prec' => 10, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'ontology_synonym', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 1500, 'Nulls' => 0, 'base_type' => 'not set'}, 
      ...
      {'col' => 'is_preferred', 'type' => 'NUMBER', 'prec' => 1, 'length' => 22, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'definition', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 4000, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'variable', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 1500, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'display_order', 'type' => 'NUMBER', 'prec' => 6, 'length' => 22, 'Nulls' => 1, 'base_type' => 'not set'}, 
      ...
      {'col' => 'annotation_properties', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 3200, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'ordinal_values', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 1500, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'plural', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 1500, 'Nulls' => 1, 'base_type' => 'not set'});

  $self->setRealTableName('GUS::Model::SRes::OntologySynonym');
  ...
  $self->setPrimaryKeyList('ontology_synonym_id');
