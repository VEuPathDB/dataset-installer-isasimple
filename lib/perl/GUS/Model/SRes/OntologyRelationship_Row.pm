package GUS::Model::SRes::OntologyRelationship_Row;
...
sub setOntologyRelationshipId {
  my($self,$value) = @_;
  $self->set("ontology_relationship_id",$value);
}

sub getOntologyRelationshipId {
    my($self) = @_;
  return $self->get("ontology_relationship_id");
}

sub setSubjectTermId {
  my($self,$value) = @_;
  $self->set("subject_term_id",$value);
}

sub getSubjectTermId {
    my($self) = @_;
  return $self->get("subject_term_id");
}

sub setPredicateTermId {
  my($self,$value) = @_;
  $self->set("predicate_term_id",$value);
}

sub getPredicateTermId {
    my($self) = @_;
  return $self->get("predicate_term_id");
}

sub setObjectTermId {
  my($self,$value) = @_;
  $self->set("object_term_id",$value);
}

sub getObjectTermId {
    my($self) = @_;
  return $self->get("object_term_id");
}

sub setOntologyRelationshipTypeId {
  my($self,$value) = @_;
  $self->set("ontology_relationship_type_id",$value);
}

sub getOntologyRelationshipTypeId {
    my($self) = @_;
  return $self->get("ontology_relationship_type_id");
}
