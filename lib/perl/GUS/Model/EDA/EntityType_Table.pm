package GUS::Model::EDA::EntityType_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::EDA::EntityAttributes','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA::EntityClassification','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA::EntityTypeGraph','entity_type_id','parent_id'],
      ['GUS::Model::EDA::EntityTypeGraph','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA::AttributeUnit','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA::Attribute','entity_type_id','entity_type_id']);
  ...
  $self->setRealTableName('GUS::Model::EDA::EntityType');
