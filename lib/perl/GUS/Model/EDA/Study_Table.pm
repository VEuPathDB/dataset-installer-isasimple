package GUS::Model::EDA::Study_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::EDA::EntityType','study_id','study_id'],
      ['GUS::Model::EDA::EntityTypeGraph','study_id','study_id'],
      ['GUS::Model::EDA::AttributeGraph','study_id','study_id'],
      ['GUS::Model::EDA::StudyCharacteristic','study_id','study_id']);
  ...
  $self->setRealTableName('GUS::Model::EDA::Study');
