package GUS::Model::EDA::ProcessTypeComponent_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ['GUS::Model::EDA::ProcessType','component_id','process_type_id'],
  ...
  $self->setRealTableName('GUS::Model::EDA::ProcessTypeComponent');
