package GUS::Model::EDA::ProcessAttributes_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ['GUS::Model::EDA::EntityAttributes','in_entity_id','entity_attributes_id'],
      ['GUS::Model::EDA::EntityAttributes','out_entity_id','entity_attributes_id'],
  ...
  $self->setRealTableName('GUS::Model::EDA::ProcessAttributes');
