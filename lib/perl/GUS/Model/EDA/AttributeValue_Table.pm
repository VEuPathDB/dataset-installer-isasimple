package GUS::Model::EDA::AttributeValue_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ...
      ['GUS::Model::SRes::OntologyTerm','entity_type_ontology_term_id','ontology_term_id'],
      ['GUS::Model::SRes::OntologyTerm','process_type_ontology_term_id','ontology_term_id'],
  ...
  $self->setAttInfo(
      ...
      {'col' => 'entity_type_ontology_term_id', 'type' => 'NUMBER', 'prec' => 10, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'process_type_ontology_term_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 1, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::EDA::AttributeValue');
