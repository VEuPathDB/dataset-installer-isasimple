package GUS::Model::EDA::AttributeGraph_Table;
...
sub setDefaultParams {
  ...
  $self->setAttInfo(
      ...
      {'col' => 'provider_label', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 1500, 'Nulls' => 1, 'base_type' => 'not set'}, 
      ...
      {'col' => 'scope', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 32, 'Nulls' => 1, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::EDA::AttributeGraph');
