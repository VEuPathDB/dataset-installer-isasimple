package GUS::Model::EDA_UD::ProcessType_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::EDA_UD::ProcessAttributes','process_type_id','process_type_id'],
      ['GUS::Model::EDA_UD::ProcessTypeComponent','process_type_id','process_type_id'],
      ['GUS::Model::EDA_UD::ProcessTypeComponent','process_type_id','component_id'],
      ['GUS::Model::EDA_UD::AttributeValue','process_type_id','incoming_process_type_id'],
      ['GUS::Model::EDA_UD::Attribute','process_type_id','process_type_id']);
  ...
  $self->setRealTableName('GUS::Model::EDA_UD::ProcessType');
