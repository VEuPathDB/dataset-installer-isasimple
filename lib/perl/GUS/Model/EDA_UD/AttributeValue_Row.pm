package GUS::Model::EDA_UD::AttributeValue_Row;
...
sub setIncomingProcessTypeId {
  my($self,$value) = @_;
  $self->set("incoming_process_type_id",$value);
}

sub getIncomingProcessTypeId {
    my($self) = @_;
  return $self->get("incoming_process_type_id");
}
