package GUS::Model::EDA_UD::EntityType_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::EDA_UD::EntityAttributes','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA_UD::EntityTypeGraph','entity_type_id','parent_id'],
      ['GUS::Model::EDA_UD::EntityTypeGraph','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA_UD::AttributeUnit','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA_UD::AttributeValue','entity_type_id','entity_type_id'],
      ['GUS::Model::EDA_UD::Attribute','entity_type_id','entity_type_id']);
  ...
  $self->setAttInfo(
      ...
      {'col' => 'isa_type', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 50, 'Nulls' => 1, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::EDA_UD::EntityType');
  ...
  $self->setPrimaryKeyList('entity_type_id');
