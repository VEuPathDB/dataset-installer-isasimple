package GUS::Model::EDA_UD::ProcessAttributes_Row;
...
sub setProcessAttributesId {
  my($self,$value) = @_;
  $self->set("process_attributes_id",$value);
}

sub getProcessAttributesId {
    my($self) = @_;
  return $self->get("process_attributes_id");
}
...
sub setInEntityId {
  my($self,$value) = @_;
  $self->set("in_entity_id",$value);
}

sub getInEntityId {
    my($self) = @_;
  return $self->get("in_entity_id");
}

sub setOutEntityId {
  my($self,$value) = @_;
  $self->set("out_entity_id",$value);
}

sub getOutEntityId {
    my($self) = @_;
  return $self->get("out_entity_id");
}
