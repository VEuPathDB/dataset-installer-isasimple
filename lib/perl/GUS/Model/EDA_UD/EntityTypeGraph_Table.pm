package GUS::Model::EDA_UD::EntityTypeGraph_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ...
      ['GUS::Model::EDA_UD::EntityType','parent_id','entity_type_id'],
  ...
  $self->setAttInfo(
      {'col' => 'entity_type_graph_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'study_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'study_stable_id', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 200, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'parent_stable_id', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 255, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'parent_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'stable_id', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 255, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'entity_type_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'display_name', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 200, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'display_name_plural', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 200, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'description', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 4000, 'Nulls' => 1, 'base_type' => 'not set'}, 
      {'col' => 'internal_abbrev', 'type' => 'VARCHAR2', 'prec' => '', 'length' => 50, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::EDA_UD::EntityTypeGraph');
  ...
  $self->setPrimaryKeyList('entity_type_graph_id');
