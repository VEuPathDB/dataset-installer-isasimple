package GUS::Model::EDA_UD::EntityAttributes_Table;
...
sub setDefaultParams {
  my $self = shift;
  $self->setChildList(
      ['GUS::Model::EDA_UD::ProcessAttributes','entity_attributes_id','in_entity_id'],
      ['GUS::Model::EDA_UD::ProcessAttributes','entity_attributes_id','out_entity_id'],
      ['GUS::Model::EDA_UD::AttributeValue','entity_attributes_id','entity_attributes_id']);
  ...
  $self->setRealTableName('GUS::Model::EDA_UD::EntityAttributes');
