package GUS::Model::EDA_UD::AttributeUnit_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ['GUS::Model::SRes::OntologyTerm','attr_ontology_term_id','ontology_term_id'],
  ...
  $self->setAttInfo(
      {'col' => 'attribute_unit_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'entity_type_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'attr_ontology_term_id', 'type' => 'NUMBER', 'prec' => 10, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'unit_ontology_term_id', 'type' => 'NUMBER', 'prec' => 10, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::EDA_UD::AttributeUnit');
  ...
  $self->setPrimaryKeyList('attribute_unit_id');
