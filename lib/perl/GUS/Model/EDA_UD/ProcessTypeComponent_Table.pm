package GUS::Model::EDA_UD::ProcessTypeComponent_Table;
...
sub setDefaultParams {
  ...
  $self->setParentList(
      ['GUS::Model::EDA_UD::ProcessType','component_id','process_type_id'],
  ...
  $self->setAttInfo(
      {'col' => 'process_type_component_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'process_type_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'component_id', 'type' => 'NUMBER', 'prec' => 12, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
      {'col' => 'order_num', 'type' => 'NUMBER', 'prec' => 2, 'length' => 22, 'Nulls' => 0, 'base_type' => 'not set'}, 
  ...
  $self->setRealTableName('GUS::Model::EDA_UD::ProcessTypeComponent');
  ...
  $self->setPrimaryKeyList('process_type_component_id');
